declare namespace cc {
    ...
    class LabelTTF extends Sprite {
      ...
      // cc.LabelTTF = cc.Sprite.extend(/** @lends cc.LabelTTF# */{
         ...
         */
      constructor(text?: string, fontName?: string, fontSize?: number, dimensions?: cc.Size, hAlignment?:number, vAlignment?: number); 
         ...
         */
        enableShadow(shadowColor: cc.Color, offset: number | cc.Point, blurRadius?: number): void;
        enableShadow(shadowOffsetX: number, shadowOffsetY: number, shadowOpacity: number, shadowBlur? : number): void;
        ...
        */
        setFontFillColor(fillColor: cc.Color): void;
        ...
        */
        setDimensions(dim: cc.Size | number, height?: number): void;
