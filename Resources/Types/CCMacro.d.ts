declare namespace cc {
   ...
   * @function
   */
  function RADIANS_TO_DEGREES(angle: number): number;
  ...
  const KM_GL_MODELVIEW = 0x1700;
  const KM_GL_PROJECTION = 0x1701;
  const KM_GL_TEXTURE = 0x1702;

  function kmGLMatrixMode(mode: number): void;
  function kmGLPopMatrix(): void;

  var current_stack: any;
  var _drawingUtil: any;
