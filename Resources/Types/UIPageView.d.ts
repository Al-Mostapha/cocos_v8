declare module ccui {
   ...
   * @example
   */
  class PageView extends UIListView {
    // 
    //  ctor: function () {
    ...
    //      */
    addWidgetToPage(widget:ccui.Widget,pageIdx:number,forceCreate:boolean):void
    ...
    //      */
           removePage(page:ccui.Widget):void    
    ...
    //     },
          ...
          * @param {number} idx A given index in the PageView. Index start from 0 to pageCount -1.
          */
         scrollToPage(idx:number,opt?:boolean):void
    ...
    //     },
          ...
          * @param {threshold}
          */
         setCustomScrollThreshold(threshold:number): void;
    ...
    //      * @returns {ccui.Layout}
    //      */
       getPage(index:number):ccui.Widget
