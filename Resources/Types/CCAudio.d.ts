declare namespace cc {
  ...
  class audioEngine {
     ...
     */
    static playMusic(url: string, loop: boolean): void;
    /**
     * Stop playing music.
     ...
     */
    static stopMusic(releaseData?: boolean | any): void;
    /**
     * Pause playing music.
     * @example
     * //example
     ...
     */
    static pauseEffect(audio: number): void;
    /**
     ...
     */
    static resumeEffect(audio: number): void;
    /**
     ...
     */
    static stopEffect(audio: number): void;
    /**
     ...
     */
    static unloadEffect(url: string): void;
    /**
