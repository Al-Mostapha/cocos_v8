declare module ccui {
  ...
  class CheckBox extends Widget {
    ...
    * @type {number}
    */
    static readonly EVENT_SELECTED = 0;
    /**
    * The unselected state of ccui.CheckBox's event.
    * @constant
    * @type {number}
    */
    static readonly EVENT_UNSELECTED = 1;
    ...
    * @type {number}
    */
    static readonly BOX_RENDERER_ZORDER = -1;
    /**
    * The selected Background renderer's zOrder
    * @constant
    * @type {number}
    */
    static readonly BOX_SELECTED_RENDERER_ZORDER = -1;
    /**
    * The disabled Background renderer's zOrder
    * @constant
    * @type {number}
    */
    static readonly BOX_DISABLED_RENDERER_ZORDER = -1;
    /**
    * The normal front renderer's zOrder
    * @constant
    * @type {number}
    */
    static readonly FRONT_CROSS_RENDERER_ZORDER = -1;
    /**
    * The disabled front renderer's zOrder
    * @constant
    * @type {number}
    */
    static readonly FRONT_CROSS_DISABLED_RENDERER_ZORDER = -1;
  }
}
